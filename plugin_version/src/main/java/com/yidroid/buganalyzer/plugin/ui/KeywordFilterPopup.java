...
public class KeywordFilterPopup extends JPanel {
    ...
    private void initUI() {
        ...
        // Checkbox for AND/OR logic
        matchAllCheckBox = new JBCheckBox("Match All (AND)");
        matchAllCheckBox.setToolTipText("If checked, lines must contain ALL selected keywords. Default is ANY (OR).");
        ...
        leftControls.add(manageBtn);
        leftControls.add(Box.createHorizontalStrut(10));
        leftControls.add(matchAllCheckBox);
        ...
        setPreferredSize(new Dimension(500, 500)); // Widen for new button
    }
    
    private JBCheckBox matchAllCheckBox;
    
    public boolean isMatchAllSelected() {
        return matchAllCheckBox != null && matchAllCheckBox.isSelected();
    }
