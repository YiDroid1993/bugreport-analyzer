...
import com.yidroid.buganalyzer.core.RecentProjectsManager;
...
public class WelcomePanel extends JPanel {
    ...
    private void processZipFile(File zipFile) {
        ...
        new Thread(() -> {
            try {
                com.yidroid.buganalyzer.core.ZipExtractor extractor = new com.yidroid.buganalyzer.core.ZipExtractor();
                ...
                com.yidroid.buganalyzer.model.ProjectManifest manifest = com.yidroid.buganalyzer.core.ZipExtractor.extractProject(zipFile);
                
                // Save JSON
                File projectDir = new File(new File(manifest.getOriginalZipPath()).getParent(), manifest.getProjectName());
                com.yidroid.buganalyzer.core.ProjectManager.saveProject(manifest, projectDir);
    ...
    private void loadProjectFromFile(File jsonFile) {
        try {
            com.yidroid.buganalyzer.model.ProjectManifest manifest = com.yidroid.buganalyzer.core.ProjectManager.loadProject(jsonFile);
    ...
    private void loadProjectInternal(com.yidroid.buganalyzer.model.ProjectManifest manifest, String projectPath) {
